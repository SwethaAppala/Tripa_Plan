...
public class RecyclerViewDiscussionAdapter extends RecyclerView.Adapter<RecyclerViewDiscussionAdapter.MyViewHolder> {
    List<Message> list;
    Context context;
    FirebaseAuth mAuth;
    FirebaseUser mUser;
    ...
    public RecyclerViewDiscussionAdapter(List<Message> list, Context context) {
        this.list = list;
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull RecyclerViewDiscussionAdapter.MyViewHolder holder, int position) {
